#ifndef dagr_variant_array_operator
#define dagr_variant_array_operator

#include "dagr_variant_array.h"
#include "dagr_type_select.h"

namespace dagr_variant_array_operator
{
namespace internal
{
// --------------------------------------------------------------------------
template <typename nt_arg1, typename nt_arg2, typename nt_arg3,
    typename operator_t, typename type_select_t =
        typename dagr_type_select::elevate<nt_arg2, nt_arg3>>
p_dagr_variant_array apply(unsigned long n,
    const nt_arg1 *parg1, const nt_arg2 *parg2, const nt_arg3 *parg3,
    const operator_t &op)
{
    using nt_out = typename type_select_t::type;

    p_dagr_variant_array_impl<nt_out> out =
        dagr_variant_array_impl<nt_out>::New(n);
...
template <typename nt_larg, typename nt_rarg, typename operator_t,
    typename type_select_t = typename dagr_type_select::elevate<nt_larg, nt_rarg>>
p_dagr_variant_array apply(unsigned long n,
...
{
    p_dagr_variant_array_impl<nt_arg> out =
        dagr_variant_array_impl<nt_arg>::New(n);
...
p_dagr_variant_array apply(const const_p_dagr_variant_array &arg1,
    const const_p_dagr_variant_array &arg2, const const_p_dagr_variant_array &arg3,
    const operator_t &op)
{
    NESTED_TEMPLATE_DISPATCH(const dagr_variant_array_impl,
        arg1.get(), _1,
    ...
    DAGR_ERROR("failed to apply " << operator_t::name() << ". unsupported type.")
    return nullptr;
}

// --------------------------------------------------------------------------
template <typename operator_t>
p_dagr_variant_array apply_i(const const_p_dagr_variant_array &larg,
    const const_p_dagr_variant_array &rarg, const operator_t &op)
{
    NESTED_TEMPLATE_DISPATCH_I(const dagr_variant_array_impl,
        larg.get(), _LEFT,
...
// --------------------------------------------------------------------------
template <typename operator_t>
p_dagr_variant_array apply(const const_p_dagr_variant_array &larg,
    const const_p_dagr_variant_array &rarg, const operator_t &op)
{
    NESTED_TEMPLATE_DISPATCH(const dagr_variant_array_impl,
        larg.get(), _LEFT,
...
// --------------------------------------------------------------------------
template <typename operator_t>
p_dagr_variant_array apply(const const_p_dagr_variant_array &arg,
    const operator_t &op)
{
...
{
template<typename nt_arg1, typename nt_arg2, typename nt_arg3,
typename nt_out = typename dagr_type_select::elevate<nt_arg2, nt_arg3>::type>
...
typename nt_out = typename dagr_type_select::elevate<nt_larg, nt_rarg>::type>   \
...
struct resolver
{
    static int invoke(const char *op, p_dagr_variant_array &r,
        const const_p_dagr_variant_array &a1, const const_p_dagr_variant_array &a2,
        const const_p_dagr_variant_array &a3)
    {
        switch (*op)
        {
        ...
        r = nullptr;
        DAGR_ERROR("binary operation " << op << " is not implemented")
        return -1;
    }
    static int invoke(const char *op, p_dagr_variant_array &r,
        const const_p_dagr_variant_array &a1, const const_p_dagr_variant_array &a2)
    ...
    static int invoke(const char *op, p_dagr_variant_array &r,
        const const_p_dagr_variant_array &a1)
    {
        switch (*op)
        {
            case '!':
        ...
        r = nullptr;
        DAGR_ERROR("unary operation " << op << " is not implemented")
        return -1;
    }
