#ifndef dagr_variant_array_operand_h
#define dagr_variant_array_operand_h
...
public:
    ...
    // otherwise.
    int get_constant(const char *s, p_dagr_variant_array &c);
    ...
    int get_variable(const char *var_name,
        const_p_dagr_variant_array &var)
    {
    ...
    // resolution.
    const_p_dagr_array_collection get_variables()
    { return m_variables; }

    void set_variables(const_p_dagr_array_collection v)
    { m_variables = v; }

private:
    const_p_dagr_array_collection m_variables;
};
