...
#  define DAGR_WINDOWS_DEPRECATED_GetVersionEx
# endif
# include <errno.h>
# if defined(DAGR_SYS_HAS_PSAPI)
#  include <psapi.h>
# endif
...
# if defined(DAGR_SYS_HAS_IFADDRS_H)
#  include <ifaddrs.h>
#  define DAGR_IMPLEMENT_FQDN
# endif
#endif
...
#if defined(DAGR_SYS_HAS_MACHINE_CPU_H)
...
#  endif
# endif
# if defined(DAGR_CXX_HAS_RLIMIT64)
...
#if defined(DAGR_HAS_BACKTRACE)
# include <execinfo.h>
# if defined(DAGR_HAS_CPP_DEMANGLE)
#  include <cxxabi.h>
# endif
# if defined(DAGR_HAS_SYMBOL_LOOKUP)
#  include <dlfcn.h>
# endif
#else
# undef DAGR_HAS_CPP_DEMANGLE
# undef DAGR_HAS_SYMBOL_LOOKUP
#endif
...
# if defined(BUS_OBJERR)
    ...
    oss << std::endl << "program stack:" << std::endl
        << dagr_system_interface::get_program_stack(2, 0)
        << "=========================================================" << std::endl;
    ...
    // and abort
    dagr_system_interface::set_stack_trace_on_error(0);
    abort();
#else
    // avoid warning C4100
    (void)sig_no;
...
#elif defined(DAGR_HAS_BACKTRACE)
...
namespace dagr_system_interface
{
// **************************************************************************
...
#elif !defined(DAGR_HAS_DEBUG_BUILD)
