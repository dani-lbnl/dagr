#ifndef dagr_algorithm_fwd_h
#define dagr_algorithm_fwd_h

#include "dagr_shared_object.h"
#include <initializer_list>

DAGR_SHARED_OBJECT_FORWARD_DECL(dagr_algorithm)
...
#define DAGR_ALGORITHM_STATIC_NEW(T)                \
                                                    \
static p_##T New()                                  \
{                                                   \
    return p_##T(new T);                            \
...
{                                                   \
    return std::static_pointer_cast<T>(             \
        dagr_algorithm::shared_from_this());        \
}                                                   \
                                                    \
...
#define DAGR_ALGORITHM_DELETE_COPY_ASSIGN(T)    \
                                                \
...
#define DAGR_ALGORITHM_PROPERTY(T, NAME) \
                                         \
...
// where X is the name of a class member. will manage the
// algorithm's modified state for the user.
#define DAGR_ALGORITHM_VECTOR_PROPERTY(T, NAME)         \
                                                        \
...
{                                                       \
    ...
    {                                                   \
        ...
        this->set_modified();                           \
                                                        ...
                                                        \
void set_##NAME##s(const const_p_dagr_variant_array &v) \
{                                                       \
    v->get(this->NAME##s);                              \
    this->set_modified();                               \
}                                                       \
...
{                                                       \
    v = this->NAME##s;                                  \
                                                        ...
                                                        \
void get_##NAME##s(const p_dagr_variant_array &v) const \
{                                                       \
    v->set(this->NAME##s);                              \
}                                                       \
                                                        \
...
#define DAGR_ALGORITHM_CALLBACK_PROPERTY(T, NAME)   \
                                                    \
void set_##NAME(const T &v)                         \
{                                                   \
    /*if (this->NAME != v)*/                        \
