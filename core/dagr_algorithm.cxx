...
class dagr_algorithm_internals
{
public:
    dagr_algorithm_internals();
    ~dagr_algorithm_internals() noexcept;
    DAGR_ALGORITHM_DELETE_COPY_ASSIGN(dagr_algorithm_internals)
    ...
    // set/get the input
    dagr_algorithm_output_port &get_input(unsigned int i);

    void set_input(
        unsigned int conn,
        const dagr_algorithm_output_port &port);
    ...
    p_dagr_algorithm_executive get_executive();
    void set_executive(p_dagr_algorithm_executive &exec);
    ...
    // executive
    p_dagr_algorithm_executive exec;
};

// --------------------------------------------------------------------------
dagr_algorithm_internals::dagr_algorithm_internals()
            :
    name("dagr_algorithm"),
    data_cache_size(1),
    modified(1),
    exec(dagr_algorithm_executive::New())
{
    this->set_number_of_outputs(1);
}

// --------------------------------------------------------------------------
dagr_algorithm_internals::~dagr_algorithm_internals() noexcept
{}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_number_of_inputs(unsigned int n)
{
    this->inputs.clear();
    this->inputs.resize(n, dagr_algorithm_output_port(nullptr, 0));
}

// --------------------------------------------------------------------------
unsigned int dagr_algorithm_internals::get_number_of_inputs() const noexcept
{
    return this->inputs.size();
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_input(
    unsigned int conn,
    const dagr_algorithm_output_port &port)
{
...
// --------------------------------------------------------------------------
dagr_algorithm_output_port &dagr_algorithm_internals::get_input(
    unsigned int conn)
{
...
// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_number_of_outputs(unsigned int n)
{
    if (n < 1)
    {
        DAGR_ERROR("invalid number of outputs " << n)
        n = 1;
    }
...
// --------------------------------------------------------------------------
unsigned int dagr_algorithm_internals::get_number_of_outputs() const noexcept
{
    return this->data_cache.size();
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_data_cache_size(unsigned int n)
{
...
// --------------------------------------------------------------------------
unsigned int dagr_algorithm_internals::get_data_cache_size() const noexcept
{
    return this->data_cache_size;
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::clear_data_cache(unsigned int port)
{
...
// --------------------------------------------------------------------------
void dagr_algorithm_internals::pop_cache(unsigned int port, int top)
{
...
// --------------------------------------------------------------------------
int dagr_algorithm_internals::cache_output_data(
    unsigned int port,
    const dagr_metadata &request,
    const_p_dagr_dataset data)
{
...
// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm_internals::get_output_data(
    unsigned int port,
    const dagr_metadata &request)
{
    std::lock_guard<mutex> lock(this->data_cache_mutex);
    ...
    return const_p_dagr_dataset();
}

// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm_internals::get_output_data(unsigned int port)
{
    std::lock_guard<mutex> lock(this->data_cache_mutex);
...
// --------------------------------------------------------------------------
int dagr_algorithm_internals::get_modified(unsigned int port) const
{
    return this->modified[port];
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_modified(unsigned int port)
{
    this->modified[port] = 1;
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_modified()
{
    std::for_each(
...
// --------------------------------------------------------------------------
void dagr_algorithm_internals::clear_modified(unsigned int port)
{
    this->modified[port] = 0;
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::clear_modified()
{
    std::for_each(
        this->modified.begin(), this->modified.end(),
        [](int &m){ m = 0; });
...
// --------------------------------------------------------------------------
p_dagr_algorithm_executive dagr_algorithm_internals::get_executive()
{
    return this->exec;
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::set_executive(p_dagr_algorithm_executive &e)
{
    this->exec = e;
}

// --------------------------------------------------------------------------
void dagr_algorithm_internals::to_stream(ostream &os) const
{
    // TODO
    (void) os;
}
...
// --------------------------------------------------------------------------
void dagr_algorithm_internals::from_stream(istream &is)
{
    // TODO
    (void) is;
}
...
// --------------------------------------------------------------------------
p_dagr_algorithm dagr_algorithm::New()
{
    return p_dagr_algorithm(new dagr_algorithm);
}

// --------------------------------------------------------------------------
dagr_algorithm::dagr_algorithm() : internals(new dagr_algorithm_internals)
{}

// --------------------------------------------------------------------------
dagr_algorithm::~dagr_algorithm() noexcept
{
    delete this->internals;
}

// --------------------------------------------------------------------------
dagr_algorithm_output_port dagr_algorithm::get_output_port(
    unsigned int port)
{
    return dagr_algorithm_output_port(this->shared_from_this(), port);
}

// --------------------------------------------------------------------------
void dagr_algorithm::set_input_connection(
    unsigned int conn,
    const dagr_algorithm_output_port &upstream)
{
...
// --------------------------------------------------------------------------
dagr_algorithm_output_port &dagr_algorithm::get_input_connection(
    unsigned int i)
{
...
// --------------------------------------------------------------------------
void dagr_algorithm::remove_input_connection(unsigned int id)
{
    this->set_input_connection(id, dagr_algorithm_output_port(nullptr, 0));
    this->set_modified();
}

// --------------------------------------------------------------------------
void dagr_algorithm::clear_input_connections()
{
...
// --------------------------------------------------------------------------
int dagr_algorithm::cache_output_data(
    unsigned int port,
    const dagr_metadata &key,
    const_p_dagr_dataset &data)
{
...
// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm::get_output_data(
    unsigned int port,
    const dagr_metadata &key)
{
...
// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm::get_output_data(unsigned int port)
{
    return this->internals->get_output_data(port);
}

// --------------------------------------------------------------------------
void dagr_algorithm::clear_cache(unsigned int port)
{
    this->internals->clear_data_cache(port);
}

// --------------------------------------------------------------------------
void dagr_algorithm::pop_cache(unsigned int port, int top)
{
...
// --------------------------------------------------------------------------
void dagr_algorithm::set_cache_size(unsigned int n)
{
...
// --------------------------------------------------------------------------
void dagr_algorithm::set_modified()
{
    this->internals->set_modified();
}

// --------------------------------------------------------------------------
void dagr_algorithm::set_modified(unsigned int port)
{
    this->internals->set_modified(port);
}

// --------------------------------------------------------------------------
int dagr_algorithm::get_modified(unsigned int port) const
{
    return this->internals->get_modified(port);
}

// --------------------------------------------------------------------------
void dagr_algorithm::clear_modified(unsigned int port)
{
    this->internals->clear_modified(port);
}

// --------------------------------------------------------------------------
void dagr_algorithm::set_executive(p_dagr_algorithm_executive exec)
{
    this->internals->set_executive(exec);
}

// --------------------------------------------------------------------------
p_dagr_algorithm_executive dagr_algorithm::get_executive()
{
    return this->internals->get_executive();
}

// --------------------------------------------------------------------------
void dagr_algorithm::set_number_of_input_connections(unsigned int n)
{
    this->internals->set_number_of_inputs(n);
}

// --------------------------------------------------------------------------
unsigned int dagr_algorithm::get_number_of_input_connections()
{
    return internals->get_number_of_inputs();
}

// --------------------------------------------------------------------------
void dagr_algorithm::set_number_of_output_ports(unsigned int n)
{
    this->internals->set_number_of_outputs(n);
}

// --------------------------------------------------------------------------
dagr_metadata dagr_algorithm::get_output_metadata(
    unsigned int port,
    const vector<dagr_metadata> &input_md)
{
    (void)port;
...
// --------------------------------------------------------------------------
vector<dagr_metadata> dagr_algorithm::get_upstream_request(
    unsigned int port,
    const vector<dagr_metadata> &input_md,
    const dagr_metadata &request)
{
    ...
    return vector<dagr_metadata>(
        this->get_number_of_input_connections(), request);
}

// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm::execute(
        unsigned int port,
        const vector<const_p_dagr_dataset> &input_data,
        const dagr_metadata &request)
{
    (void) port;
    (void) input_data;
...
// --------------------------------------------------------------------------
dagr_metadata dagr_algorithm::get_cache_key(
    unsigned int port,
    const dagr_metadata &request) const
{
    (void) port;
    ...
    dagr_algorithm_output_port &current)
{
    ...
    vector<dagr_metadata> input_md(n_inputs);
...
// --------------------------------------------------------------------------
const_p_dagr_dataset dagr_algorithm::request_data(
    dagr_algorithm_output_port &current,
    const dagr_metadata &request)
{
    ...
    if (!out_data)
    {
        ...
        vector<const_p_dagr_dataset> input_data(n_up_reqs);
        for (unsigned int i = 0; i < n_up_reqs; ++i)
        {
            if (!up_reqs[i].empty())
            {
                dagr_algorithm_output_port conn
...
// --------------------------------------------------------------------------
int dagr_algorithm::validate_cache(dagr_algorithm_output_port &current)
{
    p_dagr_algorithm alg = get_algorithm(current);
    unsigned int port = get_port(current);
    ...
    for (unsigned int i = 0; i<n; ++i)
    {
        dagr_algorithm_output_port upstream = alg->get_input_connection(i);
...
// --------------------------------------------------------------------------
void dagr_algorithm::clear_modified(dagr_algorithm_output_port current)
{
    p_dagr_algorithm alg = get_algorithm(current);
    unsigned int port = get_port(current);
...
// --------------------------------------------------------------------------
int dagr_algorithm::update(unsigned int port_id)
{
    dagr_algorithm_output_port port = this->get_output_port(port_id);

    // make sure caches are wiped where inputs have changed
    this->validate_cache(port);

    // initialize the executive
    p_dagr_algorithm_executive exec = this->internals->get_executive();
    if (exec->initialize(this->get_output_metadata(port)))
    {
        DAGR_ERROR("failed to initialize the executive")
        return -1;
    }

    // issue requests for data
    dagr_metadata request;
...
int dagr_algorithm::update()
{
    ...
    for (unsigned int i = 0; i < n_out; ++i)
    {
        if (this->update(i))
        {
            DAGR_ERROR("failed to update port " << i)
            return -1;
        }
    }
    return 0;
...
// --------------------------------------------------------------------------
dagr_metadata dagr_algorithm::update_metadata(unsigned int port_id)
{
    dagr_algorithm_output_port port = this->get_output_port(port_id);
...
// --------------------------------------------------------------------------
void dagr_algorithm::to_stream(ostream &os) const
{
    this->internals->to_stream(os);
}

// --------------------------------------------------------------------------
void dagr_algorithm::from_stream(istream &is)
{
