#ifndef dagr_shared_object_h
#define dagr_shared_object_h

#include <memory>

// convenience macro. every dagr_algrotihm/dataset
...
#define DAGR_SHARED_OBJECT_FORWARD_DECL(_cls)           \
    class _cls;                                         \
    typedef std::shared_ptr<_cls> p_##_cls;             \
    typedef std::shared_ptr<const _cls> const_p_##_cls;

#define DAGR_SHARED_OBJECT_TEMPLATE_FORWARD_DECL(_cls)  \
