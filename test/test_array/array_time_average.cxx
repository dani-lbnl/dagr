...
// --------------------------------------------------------------------------
std::vector<dagr_metadata> array_time_average::get_upstream_request(
    unsigned int port,
    ...
    const dagr_metadata &request)
{
    ...
    {
        DAGR_ERROR("request is missing \"array_name\"")
        return up_reqs;
    }
...
// --------------------------------------------------------------------------
const_p_dagr_dataset array_time_average::execute(
    unsigned int port,
