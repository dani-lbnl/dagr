...
// --------------------------------------------------------------------------
p_dagr_dataset array::new_copy() const
{
    p_dagr_dataset a(new array());
...
// --------------------------------------------------------------------------
void array::copy(const const_p_dagr_dataset &other)
{
...
// --------------------------------------------------------------------------
void array::shallow_copy(const p_dagr_dataset &other)
{
...
// --------------------------------------------------------------------------
void array::copy_metadata(const const_p_dagr_dataset &other)
{
    const_p_array other_a = std::dynamic_pointer_cast<const array>(other);
    if (!other_a)
        throw std::bad_cast();
...
// --------------------------------------------------------------------------
void array::swap(p_dagr_dataset &other)
{
...
// --------------------------------------------------------------------------
void array::to_stream(dagr_binary_stream &s) const
{
    s.pack(this->name);
    s.pack(this->extent);
    s.pack(this->data);
...
// --------------------------------------------------------------------------
void array::from_stream(dagr_binary_stream &s)
{
    s.unpack(this->name);
