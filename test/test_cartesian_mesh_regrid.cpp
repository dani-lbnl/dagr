...
int main(int argc, char **argv)
{
    ...
    p_dagr_cf_reader tr = dagr_cf_reader::New();
    ...
    p_dagr_cf_reader sr = dagr_cf_reader::New();
    ...
    // create the regrider
    p_dagr_cartesian_mesh_regrid rg = dagr_cartesian_mesh_regrid::New();
    ...
    // create the subseter
    p_dagr_cartesian_mesh_subset ss = dagr_cartesian_mesh_subset::New();
