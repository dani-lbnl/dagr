...
int main(int argc, char **argv)
{
    ...
    p_dagr_cf_reader cfr = dagr_cf_reader::New();
    ...
    p_dagr_mask mask = dagr_mask::New();
    ...
    p_dagr_l2_norm l2n = dagr_l2_norm::New();
    ...
    p_dagr_connected_components cc = dagr_connected_components::New();
    ...
    p_dagr_time_step_executive exe = dagr_time_step_executive::New();
    exe->set_first_step(first_step);
    exe->set_last_step(last_step);

    p_dagr_vtk_cartesian_mesh_writer wri = dagr_vtk_cartesian_mesh_writer::New();
